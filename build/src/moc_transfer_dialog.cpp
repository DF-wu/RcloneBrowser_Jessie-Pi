/****************************************************************************
** Meta object code from reading C++ file 'transfer_dialog.h'
**
...
#include "../../src/transfer_dialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'transfer_dialog.h' doesn't include <QObject>."
...
const QMetaObject TransferDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_TransferDialog.data,
      qt_meta_data_TransferDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TransferDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TransferDialog.stringdata0))
        return static_cast<void*>(const_cast< TransferDialog*>(this));
