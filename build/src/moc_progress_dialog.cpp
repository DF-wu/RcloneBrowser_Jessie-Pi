...
QT_MOC_LITERAL(1, 15, 15), // "outputAvailable"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 6) // "output"

    },
    "ProgressDialog\0outputAvailable\0\0output"
};
...
void ProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ProgressDialog::*_t)(const QString & ) const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProgressDialog::outputAvailable)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProgressDialog::outputAvailable(const QString & _t1)const
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(const_cast< ProgressDialog *>(this), &staticMetaObject, 0, _a);
}
